...
// GLOBAL APP STATE
// ======================================================
enum AppState { STATE_BOOT, STATE_MENU, STATE_MUSIC, STATE_SNAKE, STATE_WIFI, STATE_MOUSE, STATE_DEAUTH };
...
const char* menuLabels[] = { "Music", "Snake", "WiFi Scan", "BT Mouse", "DeAuth" };
...
void drawMenuIcon(uint8_t idx, uint8_t tx, uint8_t TY, uint8_t TW){
  ...
  if(idx==0){
    ...
    // deauth detector: wifi arcs + X strike
    u8g2.drawDisc(cx,iy+13,2,U8G2_DRAW_ALL);
    u8g2.drawCircle(cx,iy+13,5, U8G2_DRAW_UPPER_RIGHT|U8G2_DRAW_UPPER_LEFT);
